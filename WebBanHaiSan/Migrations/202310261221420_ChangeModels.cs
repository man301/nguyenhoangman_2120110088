namespace WebBanHaiSan.Migrations
{
    ...
    public partial class ChangeModels : DbMigration
    {
        ...
        {
            AlterColumn("dbo.tb_Post", "Allias", c => c.String(maxLength: 150));
            ...
            AlterColumn("dbo.tb_Product", "Allias", c => c.String(maxLength: 250));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.tb_Product", "Allias", c => c.String());
            ...
            AlterColumn("dbo.tb_Post", "Allias", c => c.String());
        }
    }
}
